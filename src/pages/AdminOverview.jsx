...
export default function AdminOverview() {
    ...
    return <div className="mx-auto max-w-7xl space-y-6">
        <section className="rounded-2xl border border-[#0e5362] bg-gradient-to-r from-[#062f3b] to-[#104e5b] p-6 sm:p-8 text-white shadow-md"><div className="flex items-center justify-between"><div><p className="text-xs font-black uppercase tracking-[0.18em] text-[#70d0d6]">System administration</p><h2 className="mt-2 text-2xl sm:text-3xl font-black text-white" style={{ color: '#ffffff' }}>Tổng quan hệ thống</h2><p className="mt-2 text-sm text-[#c7dce2]">Tình trạng vận hành của toàn bộ nền tảng SEAL.</p></div><button type="button" onClick={load} title="Làm mới tổng quan" className="btn-secondary h-9 w-9 p-0 inline-flex items-center justify-center text-sm font-bold bg-white/10 text-white border-white/20 hover:bg-white/20">↻</button></div></section>
