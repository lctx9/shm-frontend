...
export default function Notifications() {
    ...
    const fetchNotifications = async () => {
        try {
            ...
            setError(err.message || "Unable to load notification.");
        } finally {
            setLoading(false);
        }
    };
            ...
            <section className="rounded-lg border border-blue-100 bg-white shadow-sm">
                <div className="flex items-center justify-between border-b border-blue-100 bg-blue-50 px-6 py-4">
                    ...
                    <div className="flex gap-2">
                        ...
                        <button type="button" onClick={fetchNotifications} title="Refresh notification" className="btn-secondary h-9 w-9 p-0 inline-flex items-center justify-center text-sm font-bold">↻</button>
                    </div>
                </div>
